...
const Intro = () => {
    ...
    return(
        <div ref={introRef} id="intor" tabIndex={1} className="relative h-dvh w-dvw flex items-center justify-center overflow-hidden">
            ...
            <Navigation theHref="#AboutWe" introRef={introRef as React.RefObject<HTMLDivElement>} />
        </div>
    )
}
