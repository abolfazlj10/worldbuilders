    ...
    return(
        <div id="intor" tabIndex={1} className="relative h-dvh w-dvw flex items-center justify-center overflow-hidden">
            <div className="grid grid-cols-4 pb-32 mt-auto md:grid-cols-none md:w-full md:pb-0  md:mt-0">
                <div className="text-5xl opacity-65 max-md:[writing-mode:vertical-rl] max-md:[transform:rotate(180deg)] md:[writing-mode:horizontal-tb] flex items-center">(Digital)</div>
                ...
                <div className="text-[100px] md:text-[120px] flex items-center justify-start md:justify-between gap-7 opacity-80 max-md:[writing-mode:vertical-rl] max-md:[transform:rotate(180deg)] md:[writing-mode:horizontal-tb] relative">
                    <span>B</span>
                    <span>U</span>
                ...
                <div className="text-6xl opacity-65 max-md:[writing-mode:vertical-rl] max-md:[transform:rotate(180deg)] md:[writing-mode:horizontal-tb] mb-auto md:text-[100px] md:ml-auto">zzz</div>
            </div>
