    ...
    return(
        <div id="AboutWe" tabIndex={2} className="h-dvh w-dvw overflow-hidden relative">
            <div className="flex flex-col py-8 md:py-10">
                ...
                <Image src="/image/_.png" alt="*" width={140} height={140} className="object-contain w-[100px] ml-auto -mr-7 mt-10 mb-4 md:order-3 md:absolute md:-bottom-10 md:w-[140px] md:left-10" />
