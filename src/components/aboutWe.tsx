...
const  AboutWe = ({ onNavigate }: AboutWeProps) => {
    return(
        <div id="AboutWe" tabIndex={2} className="h-dvh w-dvw overflow-hidden relative">
            <div className="flex flex-col py-10 md:py-10">
                <div className="text-secondBlue text-[45px] md:text-[70px] font-bold pl-10 md:pl-24">WHO ARE WE?</div>
                <Image src="/image/_.png" alt="*" width={140} height={140} className="object-contain w-[100px] ml-auto -mr-10 mt-10 mb-4 md:order-3 md:absolute md:-bottom-10 md:w-[140px] md:left-10" />
                <div className="font-IBM px-10 md:px-24 text-[18px] leading-[40px] font-[400] flex-1 tracking-wide md:tracking-[5px] md:text-[20px] md:leading-[40px] md:pr-32 md:mt-10 text-justify">
